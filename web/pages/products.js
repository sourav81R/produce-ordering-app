  ...
  return (
    <Layout>
      ...
      <div className="page-stack">
        <PageHeader
          title="Products"
          description="Browse the current produce catalog. Pricing is shown per unit from the backend."
        />
...
export async function getServerSideProps() {
  try {
    ...
    return {
      props: {
        products: [],
        errorMessage: 'Unable to load products from the backend right now.',
      },
    };
  }
}
